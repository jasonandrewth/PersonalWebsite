...
<SEO title={'Legal'} description={'legal'} />
...
<section class="prose text-white">
	...
	<p>
		...
		Rechtsverletzungen werden wir diese Inhalte umgehend entfernen. Haftung für Links Unser Angebot
		enthält Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb
	...
	Bekanntwerden von Rechtsverletzungen werden wir derartige Links umgehend entfernen. Urheberrecht Die
