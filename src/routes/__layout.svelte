...
<div class:dark>
	...
	{#key currentRoute}
		<main
			class="text-black dark:text-white bg-slate-50 dark:bg-black ml-12 md:ml-28 min-h-screen p-4 md:p-8 max-w-screen md:max-w-[90vw] mx-auto my-0 relative transition-all duration-250 ease-in-out"
